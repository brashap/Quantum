...
\item Note how the data in upper left, upper right, and bottom of oscilloscope changes
\end{itemize}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{4cm}
\begin{center}	
	\includegraphics[width=4cm]{fig/bandpassAmp_bb.jpg}
	\includegraphics[width=4cm]{fig/bandpassAmp_schem.jpg}
\end{center}
\end{column}
\begin{column}{7.cm}
Repeat low pass filter measurements using the amplifying bandpass on this page. 
\end{column}
\end{columns}
\end{frame}
