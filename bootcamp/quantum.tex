...
\begin{center}
\includegraphics[width=8cm]{fig/lasersafe.jpg}
\end{center}
\end{frame}
...
\end{column}
\begin{column}{5cm}
In 1678, Christian Huygens, in order to explain the diffraction of light, proposed that every point on a wavefront (of light) is a wavelet that spreads.
\begin{center}
\includegraphics[width=3.5cm]{fig/huygens.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
