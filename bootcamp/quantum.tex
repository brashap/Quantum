...
\begin{frame}\frametitle{Assignment: Calculate slit width and distance}
...
\begin{itemize}
\item Calculate the slit distance and slit width for three different single/double slits. 
\end{itemize}
...
\item Determine Laser Wavelenth (Chapter 6.2)
...
\item When told: teardown setup completely and store
\end{itemize}
\end{column}
\end{columns}
\end{frame}
