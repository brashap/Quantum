...
\begin{center}
\includegraphics[width=12cm]{fig/theTeam.jpg}
\end{center}
\end{frame}
...
\begin{column}{6.5cm}
\begin{itemize}
\item Proud husband of Krista and father of Shelby and Ethan
\item Electrical Engineer (Michigan) with 23 years industrial experience (Intel)
\item Created and taught IoT Bootcamp for 6 years (and going)
...
\begin{column}{6cm}
\begin{itemize}
\item Blessed husband of Joy and proud father of Katelyn and Kimber
...
\begin{frame}\frametitle{First Source}
\begin{columns}
\begin{column}{5cm}
\begin{itemize}
\item There is literally no textbook for a course like this.
\item The three instructors will have different perspectives on the topics.
\item We encourage you to utilize first source materials during class.
\item However, second source / AI is not allowed.
\end{itemize}
\end{column}
\begin{column}{5cm}
\begin{center}
\includegraphics[width=6cm]{fig/firstsource.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\end{itemize}
\item CPL coming soon
\begin{itemize}
\item MECH 2995 Fundamentals of Vacuum Systems
\end{itemize}
\end{itemize}
\end{frame}
...
\item Qunnect
\item City of ABQ
\item Monarch Quantum
\item Quantinuum
\item QuEra
\item Quantum NM Institute 
...
\item E) I am not familiar with this concept is an option on every question
\end{itemize}
...
\begin{frame}\frametitle{Introduction: The Problems with Classical Physics}
\begin{center}
\includegraphics[width=6cm]{fig/classicalcat.jpg}
\end{center}
\end{frame}

\begin{frame}\frametitle{Introduction: Ultraviolet Catastrophe}
\begin{columns}
\begin{column}{5.5cm}
\begin{center}
\includegraphics[width=5cm]{fig/blackbodies.jpg}
\end{center}
\end{column}
\begin{column}{5.5cm}
\begin{center}
\includegraphics[width=5.5cm]{fig/blackpots.jpg}

\vspace{0.25cm}

\includegraphics[width=5.5cm]{fig/uvcat.jpg}
\end{center}
...
\begin{frame}\frametitle{Introduction: Photoelectric Effect}
\begin{columns}
\begin{column}{6.5cm}
Classical physics predicts:
\begin{itemize}
\item Light intensity should control how much energy electrons gain.
\item There should be a delay as electrons gradually gain energy before being ejected.
\item There should be no threshold frequency - even low energy light, if intense enough should eventually cause ejection.  
\end{itemize}
Classical physics is wrong!!!!!
\end{column}
\begin{column}{4.5cm}
\begin{center}
\includegraphics[width=4.5cm]{fig/pecat.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}\frametitle{Introduction: Hydrogen Spectrum}
\begin{columns}
\begin{column}{6.5cm}
Classical electromagnetic theory states that an accelerating charge creates an electromagnetic wave, thus loosing energy. This implies
\begin{itemize}
\item An electron orbiting an atom would emit a continuous spectrum of light
\item As it looses energy, the electron orbit will decay.
\item The atom is unstable, collapsing in $10^{-10}$ seconds.
\end{itemize}
In an atom: classical physics is wrong!!!!!
\end{column}
\begin{column}{4.5cm}
\begin{center}
\includegraphics[width=4.5cm]{fig/rutherford.jpg}

\vspace{.25cm}

\includegraphics[width=4.5cm]{fig/balmercat.jpg}

\vspace{.25cm}

\includegraphics[width=3.5cm]{fig/orbitaldecay.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}\frametitle{Introduction: Superposition}
\begin{center}
\includegraphics[width=12cm]{fig/supercat.jpg}
\end{center}
\end{frame}

\begin{frame}\frametitle{Introduction: Entanglement}
\begin{center}
...
\begin{frame}\frametitle{Introduction: Particle-Wave Duality}
\begin{columns}
\begin{column}{6.5cm}
\begin{center}
\includegraphics[width=6cm]{fig/pwd.jpg}
\end{center}
\end{column}
\begin{column}{4.5cm}
\begin{center}
\includegraphics[width=4cm]{fig/pwde.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}\frametitle{Introduction: A Taste of QuBits}
\begin{center}
\includegraphics[width=12cm]{fig/taste.png}
\end{center}
\end{frame}

\begin{frame}\frametitle{Introduction: QuBits}
\begin{center}
...
\begin{frame}\frametitle{Introduction: Programming}
\begin{center}
...
\begin{frame}\frametitle{Introduction}
\begin{center}
\includegraphics[width=12cm]{fig/Slide12.jpg}
\end{center}
\end{frame}



\begin{frame}\frametitle{Introduction: Quantum Control}
\begin{columns}
\begin{column}{7cm}
	\begin{center}	
	\includegraphics[width=7cm]{fig/qmcal.jpg} 
	\end{center}
\end{column}
\begin{column}{5.5cm}
\begin{itemize}
\item Quantum Control System sends the actually pulses (lasers, microwaves, etc) to the QuBits.
\item Learn how to calibrate superconducting QuBits
\item Class competition to do the best calibration on actual QuBits at the IQCC
\end{itemize}
\end{column}
\end{columns}
\end{frame}

\begin{frame}\frametitle{Introduction: Partnerships}
\begin{center}
\includegraphics[width=12cm]{fig/Slide13.jpg}
\end{center}
\end{frame}
...
\item Select the version: 2025 SP5.0 and click Request Download.
...
\begin{frame}\frametitle{Second Cohort, Still:}
\begin{center}
...
\begin{frame}\frametitle{FUSE Personal Protective Equipment}
\begin{itemize}
\item Safety glasses must be worn on the shop floor.
\item When using the angle grinder, safety glasses and a face shield must be
worn together.
\item Closed-toe shoes must be worn at all times, in all areas.
\item Gloves cannot be worn in the woodshop, nor while operating the mill, lathe,
belt sander, or bench grinders. They are a snag hazard.
\item In areas that involve working open flames and elevated temperatures
(welding, plasma table), long-sleeved shirts and long pants are
recommended. Clothing should be made from natural fibers such as cotton
or leather.
\item Snag hazards such as jewelry, wedding rings, hoodie strings, baggie
clothes, et cetera, must be removed, and long hair must be tied back.
\end{itemize}
\end{frame}
...
\begin{frame}\frametitle{Clean Optics is Good}
\begin{center}
\includegraphics[width=8cm]{fig/saliva.jpg}
\end{center}
\url{https://www.youtube.com/watch?v=wdNS2mGSTfI}
\end{frame}

\begin{frame}\frametitle{Demonstration: Handling Optics - The "Brush" Technique}
\begin{center}
\includegraphics[width=4cm]{fig/opticscleaning.jpg}
\end{center}

There are more opinions on cleaning optics than people working in optics:
\begin{enumerate}
\item \url{https://www.youtube.com/watch?v=wdNS2mGSTfI}
\item \url{https://www.youtube.com/watch?v=9Pq4SeNmFYw}
\item \url{https://www.youtube.com/watch?v=ghqgBio2f-k}
\item \url{https://www.youtube.com/watch?v=yANMsCmkqJ0}
...
\item Place 2 mirrors to hit the target without moving hte laser nor target
\item Ask instructor to place barrier on table, use $3^{rd}$ mirror to hit target.
\item Ask instructor to remove barrier and add tube/iris. Hit target with 2 mirrors. 
\end{itemize}
\end{column}
...
\begin{column}{6.5cm}
\begin{itemize}
\item Setup laser, two mirrors on kinematic mounts, fiber coupler, multimode fiber, and power meter. 
\item Use the two mirrors to "walk" the laser into the fiber. Maximize power.
\item Switch to single mode fiber and repeat. 
\end{itemize}
\end{column}
\end{columns}
...
\begin{frame}\frametitle{Assignment: Fiber Coupling Revisited}
\begin{columns}
\begin{column}{4.5cm}
\begin{center}
\includegraphics[width=4.5cm]{fig/coupling.jpg}
...
\includegraphics[width=4cm]{fig/visfault.jpg}
...
\begin{itemize}
\item Block mirrors
\item Use visual fault locator to send light out of the fiber
\item Use two irises to define the outgoing beam path
\item Reconnect power meter and use two-mirror walk to maximize coupling to fiber
\end{itemize}
...
\item Repeat on optical table using LED light source
...
\begin{frame}\frametitle{Thin Lens Assumption and Orientation}
\begin{itemize}
\item A thin lens is defined to be one whose thickness allows rays to refract but does not allow properties such as dispersion and aberrations (i.e. it is an ideal lens)
\item In real life, lens are not ideal and things like orientation matter:
\end{itemize}

\begin{center}
\includegraphics[width=5cm]{fig/pclens.jpg}
\end{center}
...
\begin{frame}\frametitle{Beam Waist}
\begin{columns}
\begin{column}{5.5cm}
\begin{center}
\includegraphics[width=5cm]{fig/waist.jpg}
Keplerian Design
\end{center}
\end{column}
\begin{column}{5.5cm}
Beam Waist ($\omega_0$)
\begin{equation}
\omega_0 = \frac{\lambda f}{\pi \omega_{in}}
\end{equation}
where
\begin{itemize}
\item $\lambda$ is the wavelength
\item $f$ is the focal length
\item $\omega_{in}$ is the radius of the incoming beam
\end{itemize}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}\frametitle{Probability of an Outcome}
\begin{columns}
\begin{column}{5.5cm}
\begin{center}
\includegraphics[width=5.5cm]{fig/twoDice.jpg}
\end{center}
\end{column}
\begin{column}{6cm}
\begin{itemize}
\item Probability of a 7:
\[P(7) = \frac{6}{36} = 0.166 = 16.6\% \]
\item Probability of a 5:
\[P(5) = \frac{4}{36} = 0.111 = 11.1\% \]
\end{itemize}
\vspace{0.1cm}
...
\begin{column}{5,5cm}
\begin{center}
\includegraphics[width=5.5cm]{fig/probDen.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{center}
\includegraphics[width=12cm]{fig/tweezer2.png}
\end{center}
\end{frame}
...
\begin{column}{7cm}
\begin{itemize}
\item Mount a hair and shine laser (of wavelength $\lambda$) across it at a screen
...
\begin{frame}\frametitle{Applications}
\begin{center}
\includegraphics[width=12cm]{fig/interferapp.png}
\end{center}
\end{frame}
...
\begin{frame}\frametitle{Enigma Machine}
\begin{center}
\includegraphics[width=6cm]{fig/enigma.jpg}
...
\begin{frame}\frametitle{Quantum Key Distribution and BB84}
Quantum Key Distribution (QKD) is a technique that enables secure communication between two parties by sharing a secret key. One of the most well-known QKD protocols is the BB84 protocol, proposed by Charles Bennett and Gilles Brassard in 1984. In this protocol, Alice and Bob use a quantum channel to exchange qubits, allowing them to generate a shared key that is resistant to eavesdropping. 
\end{frame}
...
\begin{frame}\frametitle{Assignment: Quantum Key Distribution}
\begin{columns}
\begin{column}{5cm}
\begin{center}
...
\section{How Cold Is It?}

\begin{frame}\frametitle{Kelvin Scale}
\begin{center}
\includegraphics[width=10cm]{fig/lordKelvin.jpg}
\end{center}
The Kelvin scale is an absolute temperature scale that starts at the lowest possible temperature (absolute zero), taken to be 0K. The 19th-century British scientist Lord Kelvin first developed and proposed the scale.
\end{frame}

\begin{frame}\frametitle{Temperature Across the Solar System}
\begin{center}
\includegraphics[width=5cm]{fig/planets.jpg}
\end{center}
\end{frame}

\begin{frame}\frametitle{Cosmic Background Radiation}
\begin{center}
\includegraphics[width=5cm]{fig/cobe.jpg}
\end{center}
\end{frame}

\begin{frame}\frametitle{IBM Quantum Computer - Dillution Frig}
\begin{center}
\includegraphics[width=10cm]{fig/ibm.jpg}
\end{center}
\url{https://www.youtube.com/watch?v=4gpPHWCoWPs}
\end{frame}

\section{The Atom and Quantum Mechanics}

\begin{frame}\frametitle{Electromagnetic Spectrum}
\begin{center}
\includegraphics[width=10cm]{fig/emspec.jpg}
\end{center}
\end{frame}

\begin{frame}\frametitle{Visible Spectrum}
\begin{center}
\includegraphics[width=10cm]{fig/visspectrum.jpg}
\end{center}
\end{frame}


\begin{frame}\frametitle{Eye Sensitivity}
\begin{columns}
\begin{column}{5cm}
\begin{center}
\includegraphics[width=4.5cm]{fig/visspectrum2.jpg}
\end{center}
\end{column}
\begin{column}{6.5cm}
\begin{center}
\includegraphics[width=6cm]{fig/eyenu.png}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}\frametitle{Hydrogen Spectra - Balmer Series}
\begin{center}
\includegraphics[width=8cm]{fig/balmerspec.jpg}
\end{center}

\vspace{1cm}

The spectrum of hydrogen was known in the mid 1880. Johann Balmer, in 1885, was able to empirically calculate an equation that predicted the wavelength of the spectral lines. These lines became known as the Balmer Series. 

\[ \lambda = B \frac{m^2}{m^2-2^2} \]

where $B = 364.50682$ nm.

\end{frame}

\begin{frame}\frametitle{Hydrogen Spectral Series - Rydberg Formula}
\begin{center}
\includegraphics[width=10cm]{fig/hydspec.jpg}
\end{center}

In 1888, Johannes Rydberg generalized the Balmer equation to

\[ \frac{1}{\lambda} =  R_H (\frac{1}{n'^2} - \frac{1}{n^2} )\]

for $n > n'$ and $R_H = 1.097 \times 10^7 (m^{-1})$.
...
\begin{frame}\frametitle{Hydrogen Spectral Series - Rydberg Formula}
\begin{center}
\includegraphics[width=7cm]{fig/hydspec.jpg}
\end{center}

\begin{itemize}
\item n=1 Lyman Series
\item n=2 Balmer Series
\item n=3 Paschen Series
\item n=4 Brackett Series
\item n=5 Pfund Series
\item n=6 Humphreys Series
\end{itemize}
...
\begin{frame}\frametitle{Schrodinger's Atom}
\begin{center}
\includegraphics[width=9cm]{fig/qmatom2.png}
\end{center}
\end{frame}

\begin{frame}\frametitle{Conservation Laws of Physics}
\begin{center}
\includegraphics[width=12cm]{fig/conserve.jpg}
\end{center}
\end{frame}


\begin{frame}\frametitle{Compton Effect}
\begin{center}
\includegraphics[width=6cm]{fig/compton.png}
\end{center}
...
\begin{frame}\frametitle{de Broglie}
\begin{center}
\includegraphics[width=7cm]{fig/matterwave.jpg}
\end{center}
\end{frame}
...
\begin{frame}\frametitle{Pauli Exclusion Principle}

Each electron has a unique quantum number:

\begin{center}
\includegraphics[width=7cm]{fig/periodictable.png}

\vspace{0.25cm}

\includegraphics[width=5cm]{fig/qnumber.jpg}
\end{center}
\end{frame}

\begin{frame}\frametitle{Orbitals}
\begin{center}
\includegraphics[width=12cm]{fig/orbitals.png}
\end{center}
\end{frame}
...
\begin{frame}\frametitle{Population Inversion}
\begin{columns}
\begin{column}{5cm}
\begin{center}
\includegraphics[width=5cm]{fig/popinvert.jpg}
\end{center}
\end{column}
\begin{column}{7cm}
\begin{itemize}
\item Electrons are pumped to a short-lived excited state
\item The electrons drop to a relatively long metastable state
\item One spontaneous emission leads to stimulated emission
\item If population is not inverted (i.e., more electrons in ground state) then more likely photons will be absorbed vs stimulate emission
\end{itemize}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}\frametitle{Parts of a Laser}
\begin{columns}
\begin{column}{3.5cm}
\begin{center}
\includegraphics[width=3.5cm]{fig/laserparts.jpg}
\end{center}
\end{column}
\begin{column}{8cm}
\begin{itemize}
\item Gain Medium - a liquid, gas, or solid whose electrons get excited by energy and a light amplification process occurs. 
\item Pumping Source - atoms in the gain medium absorb energy from the pumping source, they reach an excited state.
\item Mirrors - one high reflective (near 100\%), the other partially transparent.
\end{itemize}
\end{column}
\end{columns}
...
The photons from the excited atoms bounce between the two mirrors. As they pass through the gain medium, they stimulate atoms to release more photons. This process amplifies the light. Eventually, the light becomes intense enough to pass through the output coupler as a concentrated beam of light.
\end{frame}

\begin{frame}\frametitle{Gain Medium}
\begin{itemize}
\item Solid State: solid material, typically a glass or crystalline doped with ions of rare earth metals. The doping material absorbs pumping energy and emits light
\item Gas: A current is passed through a gas mixture exciting the gas atoms and causes them to emit photons. The gases typically used are noble gases (helium, neon, argon, krypton), nitrogen, and $CO_2$.
\item Liquid: Dye lasers use a liquid dye solution (e.g. Rhodamine) as the gain medium. The dye molecules are excited by a light source, which leads to the emission of photons.
\item Semiconductor: When an electric current is passed through the PN junction of this diode, electrons and holes (electron vacancies) recombine, releasing energy in the form of photons.
\item Fiber: the core is doped with rare-earth elements like erbium, ytterbium, or neodymium. The fiber is then “pumped” with light from diode lasers, which excites the doped atoms. As these atoms release photons, the light is amplified within the fiber.
\end{itemize}
\end{frame}

\begin{frame}\frametitle{Mode of Operation}
\begin{itemize}
\item Continuous Wave (CW): emit a constant, unbroken beam of light as long as they are powered. There is no interruption or modulation in the light output.
\item Pulsed: emit light in short bursts or pulses. This mode is used when continuous operation is not practical, or when high peak power is required. Pulse duration varies by application:
\begin{itemize}
\item Milliseconds: medical treatments such as dermatology procedures.
\item Microseconds: industrial applications such as precision drilling and micro-machining.
\item Nanoseconds: scientific research
\item Pico/Femtoseconds: highly precise surgical procedures, such as eye surgeries, high precision machining, quantum technologies.
\end{itemize}
\end{itemize}
\end{frame}

\begin{frame}\frametitle{Laser by Wavelength}
\begin{center}
\includegraphics[width=10cm]{fig/laserlambda.jpg}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=6cm]{fig/coherence2.jpg}
\end{center}
\end{frame}
...
\begin{frame}\frametitle{Fabry-Perot Diode Laser}
\begin{columns}
\begin{column}{4cm}
\begin{center}
\includegraphics[width=4cm]{fig/LaserDiode.jpg}

\vspace{1cm}

\includegraphics[width=4cm]{fig/FPcavity.jpg}

\end{center}
\end{column}
\begin{column}{8cm}
\begin{itemize}
\item Semiconductor materials (e.g. GaAr or InP), resembles a PIN diode, including an active region where light emission occurs. 
\item Intrinsic region has a higher refractive index than the n- and p-type regions. This creates lateral confinement, acting as a waveguide that confines the light to propagate along the active region.
\item Both ends of the active region are cleaved facets that are parallel to each other and perpendicular to the length of the active region. One serves as a highly reflective mirror, while the other acts as a partially reflective mirror. 
\end{itemize}
\end{column}
\end{columns}
\end{frame}

\begin{frame}\frametitle{FP Cavity}
Only wavelengths that can form a standing wave mode within the cavity are allowed to oscillate. This characteristic results in the FP resonance spectrum, which consists of a series of discrete resonant modes.
\begin{center}
\includegraphics[width=4cm]{fig/FPcavity2.jpg}
\end{center}
\[ 2nL = m \lambda \]

Only the wavelengths within the gain medium spectrum (where there is sufficient gain) will be present in the output. 
\end{frame}

\section{Quantum Optics - Making Single Photon Pairs}
...
\begin{frame}\frametitle{Applications}
\begin{center}
\includegraphics[width=12cm]{fig/ghost.png}
\end{center}
\end{frame}

\begin{frame}\frametitle{Assignment: Quantum Optics - Part 1}
\begin{columns}
\begin{column}{5cm}
\begin{center}
\includegraphics[width=5cm]{fig/QOCover.jpg}
\end{center}
\end{column}
\begin{column}{6.5cm}
\begin{itemize}
\item Assemble Components per Chapter 7.1
\item Conduct Preliminary Alignment per Chapter 7.2
\item Setup Alignment Laser HBT Experiment per Chapter 7.3
\end{itemize}
\end{column}
\end{columns}
\end{frame}

\begin{frame}\frametitle{BBO Crystal: Spontaneous Parametric Down Conversion}
\begin{columns}
\begin{column}{5cm}
\begin{center}
\includegraphics[width=4cm]{fig/SPDC.png}
\end{center}
\end{column}
\begin{column}{5cm}
\begin{center}
\includegraphics[width=4cm]{fig/SPDC2.jpg}
\end{center}
\end{column}
...
\end{columns}
Incident photon:
\[E_{inc} = hf = \frac{hc}{\lambda}= 4.89 \times 10^{-19} Joules \]

Signal/Idler pair:
\[\frac{hc}{\lambda} = \frac{E_{inc}}{2}  = 2.445 \times 10^{-19} Joules\]
\[\lambda = 2 (\frac{hc}{E_{inc}}) = 810 nm\]
\end{frame}


\begin{frame}\frametitle{Assignment: Quantum Optics - Part 2}
\begin{columns}
\begin{column}{5.0cm}
\begin{center}
\includegraphics[width=4cm]{fig/QO_coinc.jpg}
\includegraphics[width=4cm]{fig/QO_a2t.jpg}
\includegraphics[width=4cm]{fig/QO_g2.jpg}
\end{center}
\end{column}
\begin{column}{6.5cm}
Setup Photon Pair Source (Chapter 7.4)
\begin{center}
\includegraphics[width=5cm]{fig/QO_PP.jpg}
\end{center}
\begin{itemize}
\item When asked to set laser to 13 mW, use Power Meter to determine necessary current.
\item Determine Delay A to T on calibration tab
\item $g2(0)$ should be greater than 75
\end{itemize}
...
\item Autocorrelations: \[g^{(2)}(0) = \frac{R_{TAB} \cdot R_T}{R_{TA} \cdot R_{TB}} \]
\begin{itemize}
...
\begin{frame}\frametitle{Auto corrleations function}
\begin{itemize}
\item $g^2(0)$ is based on probability of simultaneous events at each detector:
\[g^2(0) = \frac{P_{TAB}}{P_{TA} P_{TB}} \]
\item $P_{TA}$ is the likelihood that an event is detected at Detector A at the same time as an event on Detector T. 
\[ P_{TA} = \frac{R_{TA}}{R_T} \] 
\item Likewise for the others detectors.
\item Autocorrelation: \[g^{(2)}(0) = \frac{\frac{R_{TAB}}{R_T}}{\frac{R_{TA}}{R_T} \cdot \frac{R_{TB}}{R_T}} = \frac{R_{TAB} \cdot R_T}{R_{TA} \cdot R_{TB}} \]
\end{itemize}
\end{frame}



\begin{frame}\frametitle{Assignment: Quantum Optics - GRA Experiment}
\begin{columns}
\begin{column}{5.0cm}
\begin{center}
\begin{center}
\includegraphics[width=5cm]{fig/QO_GRA2.jpg}
\end{center}
\end{center}
\end{column}
\begin{column}{6.5cm}
Grangier-Roger-Aspect (Chapter 7.5)
\begin{center}
\includegraphics[width=5cm]{fig/QO_GRA.jpg}
\end{center}
\begin{itemize}
\item Position Beamsplitter
\item Position Third Detector
\item Align Third Detector
\item $g^2(0)$ should be less than 0.1
\end{itemize}
...
\begin{frame}\frametitle{Assignment: Quantum Optics - Malus' Law}
\begin{columns}
\begin{column}{5.0cm}
\begin{center}
\begin{center}
\includegraphics[width=5cm]{fig/spMalus1.jpg}
\end{center}
\end{center}
\end{column}
\begin{column}{7cm}
Single Photon Malus Law (Chapter 9.6)
\begin{center}
\includegraphics[width=5cm]{fig/qop1_Malus.jpg}
\end{center}
\begin{itemize}
\item Add a linear polarizer before Detector B
\item Set polarizer to $0^{\circ}$
\item Set integration time to 20s, take a measurement.
\item Rotate polarizer in $10^{\circ}$ increments taking measurements from $0^{\circ}$ to $180^{\circ}$
\end{itemize}
\end{column}
\end{columns}
\end{frame}

\begin{frame}\frametitle{Assignment: Quantum Optics - Michelson Interferometer}
\begin{columns}
\begin{column}{6.0cm}
\begin{center}
\begin{center}
\includegraphics[width=6cm]{fig/qop1_inter.jpg}
\end{center}
\end{center}
\end{column}
\begin{column}{5cm}
\begin{itemize}
\item Follow 7.6.1 for the additional alignment path
\item Followed by the INterferometer alignment
\item And then the detector alignment
\item Take interferometer measurements
\end{itemize}
\begin{center}
\includegraphics[width=5cm]{fig/qop1_inter2.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}\frametitle{Assignment: Entangled Photons}
\begin{columns}
\begin{column}{5.0cm}
\begin{center}
\begin{center}
\includegraphics[width=5cm]{fig/esp1.png}
\end{center}
\end{center}
\end{column}
\begin{column}{6.5cm}
...
\item Align Third Detector
\item $g^2(0)$ should be less than 0.1
\item Investigate single photon Malus law (Chapter 9.6)
\end{itemize}
...
\begin{frame}\frametitle{01.0 - Mini UHV Gate Valve}
\begin{columns}
\begin{column}{5.0cm}
\begin{center}
\begin{center}
\includegraphics[width=5cm]{fig/vatValve.jpg}
\end{center}
\end{center}
\end{column}
\begin{column}{6.5cm}
\begin{itemize}
\item Vacuum range $7.5 \cdot 10^{-11}$ Torr to $1500$ Torr
\item Free of lubricants
\item No valve mechanism in vacuum
\item Bake out temperature up to $250^{\circ}C$
\end{itemize}
\end{column}
\end{columns}
\end{frame}

\begin{frame} \frametitle{Viton™ Fluoroelastomers Sealing Surface}
\begin{center}
\includegraphics[width=9cm]{fig/vatValve2.jpg}
\end{center}
\end{frame}
...
\begin{center}
\begin{center}
\includegraphics[height=7cm]{fig/vatValve3.jpg}
\end{center}
\end{center}
\end{column}
\begin{column}{4.0cm}
\begin{center}
\includegraphics[height=7cm]{fig/vatValve4.jpg}
\end{center}
\end{column}
\end{columns}
\end{frame}
