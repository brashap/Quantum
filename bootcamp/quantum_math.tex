...
\begin{frame}\frametitle{Vescent Laser Servo and Spectroscopy Module}
\begin{columns}
\begin{column}{4cm}
\includegraphics[width=3.5cm]{fig/d2-125.jpg}
\includegraphics[width=3.5cm]{fig/d2-210.jpg}
\end{column}
\begin{column}{7cm}
\begin{itemize}
\item A laser servo's purpose is to act as a feedback control system to lock a laser's frequency or wavelength to a stable reference.
\item Together with the spectroscopy module continuously monitors for any deviations from the target frequency.
\item It generates an error signal, calculates a corrective signal using a PID controller and sends it back to the laser to stabilize it
\end{itemize}
\end{column}
\end{columns}
\end{frame}

\begin{frame}\frametitle{PID Control: Cruise Control Example}
\begin{center}
\includegraphics[width=6cm]{fig/cruiseLogo.jpg}
\end{center}
\url{https://youtu.be/XfAt6hNV8XM?si=DFWqnSe2hT0wGM92}
\end{frame}

\begin{frame}\frametitle{PID Control: The "Plant" (the car)}
\begin{center}
\includegraphics[width=12cm]{fig/cruise.jpg}
\end{center}
\end{frame}

\begin{frame}\frametitle{PID Control: Proportional Control}
\begin{center}
\includegraphics[width=12cm]{fig/cruise2.jpg}
\end{center}
\end{frame}

\begin{frame}\frametitle{PID Control: Proportional Control}
\begin{center}
\includegraphics[width=12cm]{fig/cruise3.jpg}
\end{center}
\end{frame}

\begin{frame}\frametitle{PID Control: Adding in D}
\begin{center}
\includegraphics[width=12cm]{fig/cruise4.jpg}
\end{center}
\end{frame}

\begin{frame}\frametitle{PID Control: Adding in I}
\begin{center}
\includegraphics[width=12cm]{fig/cruise5.jpg}
\end{center}
\end{frame}
